...
export const Zone = {
  ...
  fromJSON(object: any): Zone {
    return {
      ...
      aggregateIntent: Array.isArray(object?.aggregateIntent)
        ? object.aggregateIntent.map((e: any) => ValidatorIntent.fromJSON(e))
        : [],
      ...
      validatorSelectionAllocation: isSet(object.validatorSelectionAllocation)
        ? Long.fromValue(object.validatorSelectionAllocation)
        : Long.UZERO,
  ...
  toJSON(message: Zone): unknown {
    ...
    message.delegationAddress !== undefined
      && (obj.delegationAddress = message.delegationAddress ? ICAAccount.toJSON(message.delegationAddress) : undefined);
    ...
    message.validatorSelectionAllocation !== undefined
      && (obj.validatorSelectionAllocation = (message.validatorSelectionAllocation || Long.UZERO).toString());
    message.holdingsAllocation !== undefined
      && (obj.holdingsAllocation = (message.holdingsAllocation || Long.UZERO).toString());
  ...
  fromPartial<I extends Exact<DeepPartial<Zone>, I>>(object: I): Zone {
    ...
    message.performanceAddress = (object.performanceAddress !== undefined && object.performanceAddress !== null)
      ...
      : undefined;
    message.delegationAddress = (object.delegationAddress !== undefined && object.delegationAddress !== null)
      ? ICAAccount.fromPartial(object.delegationAddress)
      : undefined;
    ...
    message.validatorSelectionAllocation =
      (object.validatorSelectionAllocation !== undefined && object.validatorSelectionAllocation !== null)
        ? Long.fromValue(object.validatorSelectionAllocation)
        : Long.UZERO;
    message.holdingsAllocation = (object.holdingsAllocation !== undefined && object.holdingsAllocation !== null)
      ? Long.fromValue(object.holdingsAllocation)
      : Long.UZERO;
...
function createBaseDistribution(): Distribution {
  return { valoper: "", amount: Long.UZERO };
}
...
export const WithdrawalRecord = {
  ...
  fromJSON(object: any): WithdrawalRecord {
    return {
      ...
      distribution: Array.isArray(object?.distribution)
...
function createBaseUnbondingRecord(): UnbondingRecord {
  return { chainId: "", epochNumber: Long.ZERO, validator: "", relatedTxhash: [] };
}
...
export const UnbondingRecord = {
  ...
  fromPartial<I extends Exact<DeepPartial<UnbondingRecord>, I>>(object: I): UnbondingRecord {
    const message = createBaseUnbondingRecord();
    message.chainId = object.chainId ?? "";
...
export const RedelegationRecord = {
  ...
  fromPartial<I extends Exact<DeepPartial<RedelegationRecord>, I>>(object: I): RedelegationRecord {
    const message = createBaseRedelegationRecord();
    message.chainId = object.chainId ?? "";
    message.epochNumber = (object.epochNumber !== undefined && object.epochNumber !== null)
      ? Long.fromValue(object.epochNumber)
