...
{bal.denom === 'uqosmo' && <a href="https://tfm.com/bridge?chainFrom=osmosis-1&chainTo=quicksilver-2&token0=ibc%2FEAF76AD1EEF7B16D167D87711FB26ABE881AC7D9F7E6D0CF313D5FA530417208" target="_blank" className="pool-text"> Deposit <span><img className="pool"  src={ExternalLink}/></span></a>}
{bal.denom === 'uqsomm' && <a href="https://tfm.com/bridge?chainFrom=osmosis-1&chainTo=quicksilver-2&token0=ibc%2F42D24879D4569CE6477B7E88206ADBFE47C222C6CAD51A54083E4A72594269FC" target="_blank" className="pool-text"> Deposit <span><img className="pool"  src={ExternalLink}/></span></a>}
