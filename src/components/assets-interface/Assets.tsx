...
{bal.denom === 'uqosmo' && <a href="https://app.osmosis.zone/pool/956" target="_blank" className="pool-text">Pool on Osmosis <span><img className="pool"  src={ExternalLink}/></span></a>}
