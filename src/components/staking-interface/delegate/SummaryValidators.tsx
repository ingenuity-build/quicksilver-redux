  ...
  const onStakeClick = async (e: any) => {
    ...
    return (
        ...
        <div className="summary-validator-pane d-flex mt-4 justify-content-center align-items-center flex-column">
            ...
            <h5>Redemption Rate:  <span className="font-bold">1 {selectedNetwork.local_denom[1] + selectedNetwork.local_denom.slice(2).toUpperCase()} =  {parseFloat(selectedNetwork?.redemption_rate).toFixed(8)} {selectedNetwork.base_denom.slice(1).toUpperCase()} </span></h5>
