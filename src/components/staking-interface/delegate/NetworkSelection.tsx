...
export default function NetworkSelection() {
  ...
  let beforeTime = Moment('11:00', format);
    let afterTime = Moment('12:30', format);
...
{showOsmoMessage && <h5 className="mt-5">OSMO deposits are disabled during the Osmosis epoch boundary from 17:00 to 17:30 UTC.</h5>}
