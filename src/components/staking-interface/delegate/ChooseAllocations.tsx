...
useEffect(() => {
 ...
 {/* {networkAddress && selectedNetwork !== "Select a network" && balances && <div className="wallet-details d-flex flex-column mt-3">
        ...
        <button disabled={sum < 99.9  || sum  > 100 || stakingAmount < 0.001 || stakingAmount > (zoneBalance - 0.3)?  true: false}  className="next-button mx-3" onClick={onClickNext}>Next</button> 
</div>
        </div> 
    );
