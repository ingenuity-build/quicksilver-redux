...
useEffect(() => {
 ...
 {/* {networkAddress && selectedNetwork !== "Select a network" && balances && <div className="wallet-details d-flex flex-column mt-3">
           ...
           {(zoneBalance) > 0.31 &&  <div className="staking-pane d-flex flex-column mt-4">
                ...
                Signalling Intent will be enabled soon. Until such time, your stake will be allocated evenly amongst all the active validators of the chains supported by Quicksilver. However, you can use the sliders now to determine how you would like the protocol to start allocating your stake once Signalling intent is enabled.
            <br/>
            <br/>
